 ...
 * and modifying functions so that they communicate by passing arguments. The analyze_hand
 * function needs to change the straight, flush, four, three, and pairs variables, so it will
 * have to be passed pointers to those variables,
 *
 */
#include <stdbool.h>
#include <stdio.h>
...
void print_result(const bool *, const bool *, const bool *, const bool *, const int *);

/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

int main(void) 
// calls read_cards, analyze,hand, and print_result repeatedly.
{
