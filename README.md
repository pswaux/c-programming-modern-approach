...
```bash
  ...
  $ gcc src/foo.c -o bin/foo    // separate the source codes and the binary files    
```
...
* [Chapter 7](https://github.com/pswaux/c-programming-modern-approach/tree/main/Projects/07) - Basic Types
